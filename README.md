...
### V4.1.4 stability patch
- Normalizes OHLCV columns to float64 before indicator math.
- Squeeze/release uses 0/1 NumPy arrays and cannot crash the app on nullable pandas booleans.
- Optional squeeze failure falls back safely instead of stopping Analyze, Scanner, or Backtest Lab.
