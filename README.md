# AI Stock Hunter V5.3.2 FULL

V5.3.2 keeps the V5.3 scoring and calibration logic intact, while improving confidence transparency and chart control.
...
## Model calculations unchanged in V5.3.2
...
- Added an app/engine version-sync warning. If `app.py` and `quant_engine.py` are not from the same V5.3.2 package, the app warns before results are trusted.
