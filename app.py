...
APP_VERSION = "5.9.1"
APP_BUILD_ID = "V591-EXCEL-ALL-TABS-20260915-A"
...
with tab1:
    ...
    if st.button("Run V5.9.1 Dynamic analysis"):
...
with tab4:
    st.markdown("<div class='section'>V5.9.1 Walk-Forward Validation Lab</div>", unsafe_allow_html=True)
    ...
    if st.button("Run V5.9.1 Walk-Forward Validation", key="run_multi_validation"):
        tickers=[]
        ...
        if len(tickers)<3:
            ...
            st.info("V5.9.1 gate: do not change live weights yet. A component should survive multiple unseen chronological folds and many stocks before weight optimization.")
...
with tab6:
    ...
    if st.button("Run Explosive Walk-Forward",key="run_ex_wf"):
        ...
        elif not callable(explosive_walkforward): st.error("V5.9.1 quant engine is missing explosive_walkforward(). Upload the matching quant_engine.py.")
        else:
