...
APP_VERSION = "5.9.9"
APP_BUILD_ID = "V599-RESILIENT-SCAN-LIVELEVELS-20260915-A"
...
_JOB_DIR=Path(os.getenv('AI_STOCK_HUNTER_JOB_DIR','/tmp/ai_stock_hunter_v599')); _JOB_DIR.mkdir(parents=True,exist_ok=True)
if not hasattr(builtins,'_AI_STOCK_HUNTER_JOBS'): builtins._AI_STOCK_HUNTER_JOBS={}
_SCAN_JOBS=builtins._AI_STOCK_HUNTER_JOBS

def _job_paths(job_id): return _JOB_DIR/f'{job_id}.json', _JOB_DIR/f'{job_id}.pkl'
def _write_job(job):
