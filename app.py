...
APP_VERSION = "5.8.1"
APP_BUILD_ID = "V581-CORR-CHART-20260914-A"
...
st.set_page_config(page_title="AI Stock Hunter — V5.8.1",page_icon="📈",layout="wide",initial_sidebar_state="collapsed")
st.markdown("""<style>
...
st.markdown("""<div class='hero'><span class='badge'>V5.8.1 • COMPONENT OVERLAP • ENTRY VALIDATION • STABLE CHART</span><div class='hero-title'>📈 AI Stock Hunter<br>V5.8.1</div><div class='hero-sub'>Smart Money • Early Accumulation • Precision Entry • Walk-forward Backtest • Confidence Engine</div></div>""",unsafe_allow_html=True)
...
with tab4:
    st.markdown("<div class='section'>V5.8.1 Walk-Forward Validation Lab</div>", unsafe_allow_html=True)
    ...
    if st.button("Run V5.8.1 Walk-Forward Validation", key="run_multi_validation"):
        tickers=[]
