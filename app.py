...
st.set_page_config(page_title="AI Stock Hunter — V5.2.2",page_icon="📈",layout="wide",initial_sidebar_state="collapsed")
st.markdown("""<style>
...
st.markdown("""<div class='hero'><span class='badge'>V5.2.2 • IMPORT HOTFIX • EARLY EVENT BACKTEST</span><div class='hero-title'>📈 AI Stock Hunter<br>V5.2.2</div><div class='hero-sub'>Smart Money • Early Accumulation • Precision Entry • Walk-forward Backtest • Confidence Engine</div></div>""",unsafe_allow_html=True)
...
with tab1:
    ...
    if st.button("Run V5.2.2 analysis"):
