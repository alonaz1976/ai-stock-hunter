...
st.set_page_config(page_title="AI Stock Hunter — Quant V4",page_icon="📈",layout="wide",initial_sidebar_state="collapsed")
st.markdown("""<style>
...
st.markdown("""<div class='hero'><span class='badge'>QUANT V4 • EARLY PREDICTION • ENTRY ENGINE</span><div class='hero-title'>📈 AI Stock Hunter<br>Quant V4</div><div class='hero-sub'>Smart Money • Early Accumulation • Precision Entry • Walk-forward Backtest • Confidence Engine</div></div>""",unsafe_allow_html=True)
