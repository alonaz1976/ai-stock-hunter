...
APP_VERSION = "5.8.2"
APP_BUILD_ID = "V582-UNIQUE-LIFT-20260914-A"
...
st.set_page_config(page_title="AI Stock Hunter — V5.8.2",page_icon="📈",layout="wide",initial_sidebar_state="collapsed")
st.markdown("""<style>
...
st.markdown("""<div class='hero'><span class='badge'>V5.8.2 • UNIQUE LIFT • COMPONENT OVERLAP • ENTRY VALIDATION</span><div class='hero-title'>📈 AI Stock Hunter<br>V5.8.2</div><div class='hero-sub'>Smart Money • Early Accumulation • Precision Entry • Walk-forward Backtest • Confidence Engine</div></div>""",unsafe_allow_html=True)
...
with tab4:
    st.markdown("<div class='section'>V5.8.2 Walk-Forward Validation Lab</div>", unsafe_allow_html=True)
    ...
    if st.button("Run V5.8.2 Walk-Forward Validation", key="run_multi_validation"):
        tickers=[]
        ...
        if len(tickers)<3:
            ...
            bar=st.progress(0, text="Starting V5.8.2 walk-forward validation...")
            ...
            for idx,t in enumerate(tickers,1):
                ...
                try:
                    ...
                    # V5.8.2 Unique-lift sample: use ONLY rows inside accepted chronological
            ...
            st.caption("V5.8.2 asks a stricter question: after the other highlighted signals are already present, does each component still add predictive information on unseen walk-forward rows? Live weights are still NOT changed.")
            if unique_frames:
            ...
            st.info("V5.8.2 gate: do not change live weights yet. A component should survive multiple unseen chronological folds and many stocks before V5.8 weight optimization.")
